...
//const GH_PAT_TARGET = 'YOUR_PAT_HERE';
//const GH_PAT_SOURCE = 'YOUR_PAT_HERE';
...
async function generateIssuesForEnvironmentsSecrets(repo, envs) {
    for (const env of envs) {
      const issueTitle = 'Update reviewers for environment: ' + `\`${env.env}\``;
      ...
      generateIssue(issueBody, issueTitle, repo);
...
async function generateIssue(body, title, repo) {
